<template>
  <div class="average-age">
    ...
    <div class="average-data-wrapper">
      <div class="average-data" v-for="(item, index) in (data as [any])" :key="index">
...
<script setup lang="ts" name="averageAge">
  ...
  const update = () => {
    ...
    if (!chart) {
      chart = Echarts.init(document.getElementById('average-age-chart') as HTMLElement)
    }
